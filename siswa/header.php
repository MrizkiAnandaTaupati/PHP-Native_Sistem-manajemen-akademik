...
<body>
  <header class="navbar navbar-dark sticky-top p-0"  style="background: #95CD41;">
    ...
    <a class="navbar-brand me-0 px-3 fs-6" href="index.php">Selamat Datang Siswa & Siswi Man 1 Cilacap</a>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 position-fixed start-0 top-0 bottom-0 py-5 collapse d-md-block sidebar"  style="background:#1A5D1A;">
        <div class="pt-3 ">
          <div class="text-center text-white mb-2">
           <img src="../asset/file/siswa/<?php echo $siswa["foto_siswa"]; ?>" class="img-fluid w-25 rounded">
           <h6><?php echo $_SESSION["siswa"]["nama_siswa"] ?></h6>
         </div>
        ...
        <ul class="nav flex-column">
          <li class="nav-item"  style="background:#1A5D1A;">
            <a class="nav-link active text-white" aria-current="page" href="profil_siswa.php">
